...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <body>
         ...
         <div class="nk-fullscreen-block-middle"></div>
         <div class="container text-center"></div>
         <div class="row"></div>
         <center>
            <h1 class="h2"><span class="text-main-1">YOU HAVE SUCCESSFULLY ADDED </span> SUBSCRIPTION PLAN </h1>
         </center>
         <center>
            <div class="text-white">You'll find your new plan in your subscription list.</div>
         </center>
         <div class="nk-gap-2"></div>
         <!-- START: MailChimp Signup Form -->
         <form  method="get" action="checkout.jsp">
            <center>  <button class="nk-btn nk-btn-rounded nk-btn-color-white ml-20" >Return to Checkout</button></center>
            </div>
         ...
         <div class="nk-page-background-fixed" style="background-image: url('images/background.jpg');"></div>
         <!-- END: Page Background -->
         <!-- START: Search Modal -->
