            ...
            <div class="banner_main">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="text-bg">
                        <center>
                           <h1>Update your Game<br> information</h1>
                        </center>
                     </div>
                  </div>
               </div>
      ...
      <body>
         <div class="form">
            <form action="updatelib" method="post">
               ...
               <label>Last Try: &nbsp &nbsp  &nbsp  &nbsp </label>
               <input type="text" name="date" value="<%=date %>"   readonly><br><br>
               <label>Description:  &nbsp   </label>
               <input type="text" name="description" value="<%=description %>"  required><br><br>
               <center>
                  <input type ="submit" name="submit" value="Update Game Data"><br><br><br>		
               </center>
            </form>
         </div>
