...
<html lang="en">
   ...
   <!-- body -->
   <body class="main-layout" style="background-color: #dbe1dd;">
      <!-- loader  -->
      <!-- end loader -->
      <!-- header -->
      <header>
               ...
               <div class="banner_main">
                  <div class="container-fluid">
                     <div class="row">
                        ...
                        <div class="text-bg">
                           <h1>Game Upload Completed</h1>
                           <span>After game is approved we will sent you an email<br>STAY STUNED...</span>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <br><br><br>
      <center>
         <form action="library" method="post" style=" border: 5px solid #f1f1f1;;
            font-family: Roboto,Arial,sans-serif;
            justify-content: center;
            font-family: Roboto, Arial, sans-serif;
            font-size: 15px;width:75%;">
            <br><br><br>
            <h1>YOUR <a href="https://github.com/pablorgarcia" target="_blank">GAMES</a></h1>
            <div class="formcontainer">
            <hr/>
            <label for="uname"><strong>Enter your User ID to continue</strong></label>
            <input type="text" placeholder="Enter UserID" name="userid" required>
            <center><button type="submit">View Games</button></center>
            <br>  <br> 
